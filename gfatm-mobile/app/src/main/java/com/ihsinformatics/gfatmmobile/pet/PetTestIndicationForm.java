...
public class PetTestIndicationForm extends AbstractFormActivity implements RadioGroup.OnCheckedChangeListener {
    ...
    public View onCreateView(LayoutInflater inflater,
        ...
        pageCount = 1;
        formName = Forms.PET_TEST_INDICATION_FORM;
        form = Forms.pet_test_indication_form;
    ...
    public void initViews() {
        ...
        chestXray = new TitledRadioGroup(context, null, getResources().getString(R.string.ctb_chest_xray), getResources().getStringArray(R.array.yes_no_options), getResources().getString(R.string.no), App.HORIZONTAL, App.VERTICAL, true, "REFERRED CHEST X RAY", getResources().getStringArray(R.array.yes_no_list_concept));
...
// TODO: handle exception
    ...
    public void onCheckedChanged(RadioGroup group, int checkedId) {
        ...
        if (group == mriScan.getRadioGroup()) {
            mriScan.getQuestionView().setError(null);
        }

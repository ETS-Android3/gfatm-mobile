    ...
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
        ...
        switch (oldVersion) {
            ...
            case 63: // Script to upgrade from version 63 to 64
                ...
                break;
            case 64: // Script to upgrade from version 64 to 65
                insertsStream = context.getResources().openRawResource(R.raw.db_update_v65);
                break;
            case 65: // Script to upgrade from version 65 to 66
                insertsStream = context.getResources().openRawResource(R.raw.db_update_v66);
                break;
            case 66: // Script to upgrade from version 66 to 67
                insertsStream = context.getResources().openRawResource(R.raw.db_update_v67);
                break;
            case 67: // Script to upgrade from version 67 to 68
                insertsStream = context.getResources().openRawResource(R.raw.db_update_v68);
                break;
            case 68: // Script to upgrade from version 68 to 69
                insertsStream = context.getResources().openRawResource(R.raw.db_update_v69);
                break;
            case 69: // Script to upgrade from version 69 to 70
                insertsStream = context.getResources().openRawResource(R.raw.db_update_v70);
                break;
            case 70: // Script to upgrade from version 70 to 71
                insertsStream = context.getResources().openRawResource(R.raw.db_update_v71);
                break;
            case 71: // Script to upgrade from version 71 to 72
                insertsStream = context.getResources().openRawResource(R.raw.db_update_v72);
                break;
            case 72: // Script to upgrade from version 72 to 73
                insertsStream = context.getResources().openRawResource(R.raw.db_update_v73);
                break;
            case 73: // Script to upgrade from version 73 to 74
                insertsStream = context.getResources().openRawResource(R.raw.db_update_v74);
                break;
            case 74: // Script to upgrade from version 74 to 75
                insertsStream = context.getResources().openRawResource(R.raw.db_update_v75);
                break;
            case 75: // Script to upgrade from version 75 to 76
                insertsStream = context.getResources().openRawResource(R.raw.db_update_v76);
                break;
            case 76: // Script to upgrade from version 76 to 77
                insertsStream = context.getResources().openRawResource(R.raw.db_update_v77);
                break;
            ...
            case 79: // Script to upgrade from version 79 to 80
                ...
                break;
            case 80: // Script to upgrade from version 80 to 81
                insertsStream = context.getResources().openRawResource(R.raw.db_update_v81);
                break;
            case 81: // Script to upgrade from version 81 to 82
                insertsStream = context.getResources().openRawResource(R.raw.db_update_v82);
                break;
            case 82: // Script to upgrade from version 82 to 83
                insertsStream = context.getResources().openRawResource(R.raw.db_update_v83);
                break;
            case 83: // Script to upgrade from version 83 to 84
                insertsStream = context.getResources().openRawResource(R.raw.db_update_v84);
                break;
            case 84: // Script to upgrade from version 84 to 85
                insertsStream = context.getResources().openRawResource(R.raw.db_update_v85);
                break;
            case 85: // Script to upgrade from version 85 to 86
                insertsStream = context.getResources().openRawResource(R.raw.db_update_v86);
                break;
            case 86: // Script to upgrade from version 86 to 87
                insertsStream = context.getResources().openRawResource(R.raw.db_update_v87);
                break;
            case 87: // Script to upgrade from version 87 to 88
                insertsStream = context.getResources().openRawResource(R.raw.db_update_v88);
                break;
            ...
            case 89: // Script to upgrade from version 88 to 89
                ...
                break;
            case 90: // Script to upgrade from version 88 to 89
                insertsStream = context.getResources().openRawResource(R.raw.db_update_v91);
                break;
        }

...
public class ClinicianFollowupForm extends AbstractFormActivity implements RadioGroup.OnCheckedChangeListener {
    ...
    public boolean submit() {
        ...
        observations.add(new String[]{"ACTION PLAN", App.get(missedDosed).equals(getResources().getString(R.string.pet_continue_medication_greater_adherence)) ? "CONTINUE MEDICATION (HIGH ADHERENCE)" :
                (App.get(missedDosed).equals(getResources().getString(R.string.pet_continue_medication_less_adherence)) ? "CONTINUE MEDICATION (LOW ADHERENCE)" :
                        (App.get(missedDosed).equals(getResources().getString(R.string.pet_discontinue_medication)) ? "DISCONTINUE MEDICATION" : ""))});
        // Missed Dosed

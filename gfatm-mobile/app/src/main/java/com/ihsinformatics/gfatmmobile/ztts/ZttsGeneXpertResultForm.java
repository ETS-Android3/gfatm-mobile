...
public class ZttsGeneXpertResultForm extends AbstractFormActivity implements RadioGroup.OnCheckedChangeListener {
    ...
    public View onCreateView(LayoutInflater inflater,
        ...
        pageCount = 1;
        formName = Forms.ZTTS_GENEEXPERT_RESULT;
        form = Forms.ztts_geneXpertResultForm;
    ...
    public void initViews() {
        ...
        cartridgeId = new TitledEditText(context, null, getResources().getString(R.string.fast_cartridge_id), "", "", 10, RegexUtil.NUMERIC_FILTER, InputType.TYPE_CLASS_NUMBER, App.VERTICAL, true);
    ...
    public boolean submit() {
        ...
        AsyncTask<String, String, String> submissionFormTask = new AsyncTask<String, String, String>() {
            ...
            protected String doInBackground(String... params) {
                ...
                result = serverService.saveEncounterAndObservationTesting(Forms.ZTTS_GENEEXPERT_RESULT, form, formDateCalendar, observations.toArray(new String[][]{}),id);

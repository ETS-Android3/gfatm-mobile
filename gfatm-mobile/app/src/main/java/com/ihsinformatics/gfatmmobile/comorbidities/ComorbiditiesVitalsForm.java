...
public class ComorbiditiesVitalsForm extends AbstractFormActivity implements RadioGroup.OnCheckedChangeListener {
    ...
    public void initViews() {
        ...
        gestational_age_week = new TitledEditText(context, null, getResources().getString(R.string.comorbidities_vitals_gestational_age_week), "", getResources().getString(R.string.comorbidities_vitals_gestational_age_week_range1), 3, RegexUtil.NUMERIC_FILTER, InputType.TYPE_CLASS_NUMBER, App.HORIZONTAL, false);
        fetal_weight = new TitledEditText(context, null, getResources().getString(R.string.comorbidities_vitals_fetal_weight), "", getResources().getString(R.string.comorbidities_vitals_fetal_weight_range1), 3, RegexUtil.NUMERIC_FILTER, InputType.TYPE_CLASS_NUMBER, App.HORIZONTAL, false);
        fetal_heart_rate = new TitledEditText(context, null, getResources().getString(R.string.comorbidities_vitals_fetal_heart_rate), "", getResources().getString(R.string.comorbidities_vitals_fetal_heart_rate_range1), 3, RegexUtil.NUMERIC_FILTER, InputType.TYPE_CLASS_NUMBER, App.HORIZONTAL, false);

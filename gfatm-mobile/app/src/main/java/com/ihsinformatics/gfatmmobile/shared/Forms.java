...
public class Forms{
    ...
    public static FormsObject comorbidities_mentalHealthScreening = new FormsObject(COMORBIDITIES_MENTAL_HEALTH_SCREENING_FORM, ComorbiditiesMentalHealthScreeningForm.class, R.drawable.pet_registration, FormTypeColor.REGISTRATION_FORM, new String[]{Roles.COMORBIDITIES_PROGRAM_MANAGER, Roles.COMORBIDITIES_COUNSELOR});
    public static FormsObject comorbidities_diabetesMellitusScreening = new FormsObject(COMORBIDITIES_DIABETES_MELLITUS_SCREENING_FORM, ComorbiditiesDiabetesMellitusScreeningForm.class, R.drawable.pet_registration, FormTypeColor.REGISTRATION_FORM, new String[]{Roles.COMORBIDITIES_PROGRAM_MANAGER, Roles.COMORBIDITIES_COUNSELOR});
    public static FormsObject comorbidities_hbA1cForm = new FormsObject(COMORBIDITIES_HbA1C_FORM, ComorbiditiesHbA1CForm.class, R.drawable.pet_registration, FormTypeColor.TEST_FORM, new String[]{Roles.COMORBIDITIES_PROGRAM_MANAGER, Roles.COMORBIDITIES_COUNSELOR, Roles.COMORBIDITIES_DIABETES_EDUCATOR});
    public static FormsObject comorbidities_bloodSugarForm = new FormsObject(COMORBIDITIES_BLOOD_SUGAR_FORM, ComorbiditiesBloodSugarForm.class, R.drawable.pet_registration, FormTypeColor.TEST_FORM, new String[]{Roles.COMORBIDITIES_PROGRAM_MANAGER, Roles.COMORBIDITIES_HEALTH_WORKER, Roles.COMORBIDITIES_COUNSELOR, Roles.COMORBIDITIES_DIABETES_EDUCATOR});
    public static FormsObject comorbidities_vitalsForm = new FormsObject(COMORBIDITIES_VITALS_FORM, ComorbiditiesVitalsForm.class, R.drawable.pet_registration, FormTypeColor.TREATMENT_FORM, new String[]{Roles.COMORBIDITIES_PROGRAM_MANAGER, Roles.COMORBIDITIES_HEALTH_WORKER});
    public static FormsObject comorbidities_diabetesTreatmentInitiationForm = new FormsObject(COMORBIDITIES_DIABETES_TREATMENT_INITIATION, ComorbiditiesDiabetesTreatmentInitiationForm.class, R.drawable.pet_registration, FormTypeColor.TREATMENT_FORM, new String[]{Roles.COMORBIDITIES_PROGRAM_MANAGER, Roles.COMORBIDITIES_DIABETES_EDUCATOR});
    public static FormsObject comorbidities_urineDRForm = new FormsObject(COMORBIDITIES_URINE_DR_FORM, ComorbiditiesUrineDetailedReportForm.class, R.drawable.pet_registration, FormTypeColor.TEST_FORM, new String[]{Roles.COMORBIDITIES_PROGRAM_MANAGER, Roles.COMORBIDITIES_HEALTH_WORKER, Roles.COMORBIDITIES_COUNSELOR, Roles.COMORBIDITIES_DIABETES_EDUCATOR});
    public static FormsObject comorbidities_lipidTestForm = new FormsObject(COMORBIDITIES_LIPID_TEST_FORM, ComorbiditiesLipidTestForm.class, R.drawable.pet_registration, FormTypeColor.TEST_FORM, new String[]{Roles.COMORBIDITIES_PROGRAM_MANAGER, Roles.COMORBIDITIES_HEALTH_WORKER, Roles.COMORBIDITIES_COUNSELOR, Roles.COMORBIDITIES_DIABETES_EDUCATOR});
    public static FormsObject comorbidities_creatinineTestForm = new FormsObject(COMORBIDITIES_CREATININE_TEST_FORM, ComorbiditiesCreatinineTestForm.class, R.drawable.pet_registration, FormTypeColor.TEST_FORM, new String[]{Roles.COMORBIDITIES_PROGRAM_MANAGER, Roles.COMORBIDITIES_HEALTH_WORKER, Roles.COMORBIDITIES_COUNSELOR, Roles.COMORBIDITIES_DIABETES_EDUCATOR});
    public static FormsObject comorbidities_microalbuminTestForm = new FormsObject(COMORBIDITIES_MICROALBUMIN_TEST_FORM, ComorbiditiesUrineMicroalbuminForm.class, R.drawable.pet_registration, FormTypeColor.TEST_FORM, new String[]{Roles.COMORBIDITIES_PROGRAM_MANAGER, Roles.COMORBIDITIES_HEALTH_WORKER, Roles.COMORBIDITIES_COUNSELOR});
    public static FormsObject comorbidities_diabetesTreatmentFollowupForm = new FormsObject(COMORBIDITIES_DIABETES_TREATMENT_FOLLOWUP_FORM, ComorbiditiesDiabetesTreatmentFollowupForm.class, R.drawable.pet_registration, FormTypeColor.FOLLOWUP_FORM, new String[]{Roles.COMORBIDITIES_PROGRAM_MANAGER, Roles.COMORBIDITIES_DIABETES_EDUCATOR});
    public static FormsObject comorbidities_diabetesEducationForm = new FormsObject(COMORBIDITIES_DIABETES_EDUCATION_FORM, ComorbiditiesDiabetesEducationForm.class, R.drawable.pet_registration, FormTypeColor.OTHER_FORM, new String[]{Roles.COMORBIDITIES_PROGRAM_MANAGER, Roles.COMORBIDITIES_DIABETES_EDUCATOR});
    public static FormsObject comorbidities_diabetesFootScreeningForm = new FormsObject(COMORBIDITIES_DIABETES_FOOT_SCREENING_FORM, ComorbiditiesDiabetesFootScreeningForm.class, R.drawable.pet_registration, FormTypeColor.OTHER_FORM, new String[]{Roles.COMORBIDITIES_PROGRAM_MANAGER, Roles.COMORBIDITIES_HEALTH_WORKER});
    public static FormsObject comorbidities_diabetesEyeScreeningForm = new FormsObject(COMORBIDITIES_DIABETES_EYE_SCREENING_FORM, ComorbiditiesDiabetesEyeScreeningForm.class, R.drawable.pet_registration, FormTypeColor.OTHER_FORM, new String[]{Roles.COMORBIDITIES_PROGRAM_MANAGER, Roles.COMORBIDITIES_HEALTH_WORKER});
    public static FormsObject comorbidities_treatmentFollowupMHForm = new FormsObject(COMORBIDITIES_TREATMENT_FOLLOWUP_MENTAL_HEALTH_FORM, ComorbiditiesMentalHealthTreatmentFollowupForm.class, R.drawable.pet_registration, FormTypeColor.FOLLOWUP_FORM, new String[]{Roles.COMORBIDITIES_PROGRAM_MANAGER, Roles.COMORBIDITIES_COUNSELOR});
    public static FormsObject comorbidities_assessmentFormMH = new FormsObject(COMORBIDITIES_ASSESSMENT_FORM_MENTAL_HEALTH, ComorbiditiesMentalHealthAssessmentForm.class, R.drawable.pet_registration, FormTypeColor.FOLLOWUP_FORM, new String[]{Roles.COMORBIDITIES_PROGRAM_MANAGER, Roles.COMORBIDITIES_COUNSELOR});
    public static FormsObject comorbidities_endOfTreatmentFormMH = new FormsObject(COMORBIDITIES_END_OF_TREATMENT_MENTAL_HEALTH, ComorbiditiesEndOfTreatmentMentalHealthForm.class, R.drawable.pet_registration, FormTypeColor.TREATMENT_FORM, new String[]{Roles.COMORBIDITIES_PROGRAM_MANAGER, Roles.COMORBIDITIES_COUNSELOR});
    public static FormsObject comorbidities_drugDisbursementForm = new FormsObject(COMORBIDITIES_DRUG_DISBURSEMENT, ComorbiditiesDrugDisbursement.class, R.drawable.pet_registration, FormTypeColor.OTHER_FORM, new String[]{Roles.COMORBIDITIES_PROGRAM_MANAGER, Roles.COMORBIDITIES_HEALTH_WORKER});

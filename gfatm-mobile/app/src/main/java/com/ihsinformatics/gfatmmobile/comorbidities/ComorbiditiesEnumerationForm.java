...
public class ComorbiditiesEnumerationForm extends AbstractFormActivity implements RadioGroup.OnCheckedChangeListener {
    ...
    public View onCreateView(LayoutInflater inflater,
        ...
        PAGE_COUNT = 1;
        FORM_NAME = Forms.COMORBIDITIES_ENUMERATION;
        FORM = Forms.comorbidities_enumerationForm;

        mainContent = super.onCreateView(inflater, container, savedInstanceState);
        context = mainContent.getContext();
        pager = (ViewPager) mainContent.findViewById(R.id.pager);
        pager.setAdapter(new ComorbiditiesEnumerationForm.MyAdapter());

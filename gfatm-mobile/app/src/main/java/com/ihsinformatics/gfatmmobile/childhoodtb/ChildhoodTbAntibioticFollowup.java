...
public class ChildhoodTbAntibioticFollowup extends AbstractFormActivity implements RadioGroup.OnCheckedChangeListener {
    ...
    public void initViews() {
        ...
        patientNeedMoreTests = new TitledRadioGroup(context, null, getResources().getString(R.string.ctb_patient_need_more_test), getResources().getStringArray(R.array.yes_no_options), null, App.HORIZONTAL, App.VERTICAL, true, "PRESCRIBE FURTHER TESTS", getResources().getStringArray(R.array.yes_no_list_concept));
        ...
        scheduleAnotherVisit = new TitledRadioGroup(context, null, getResources().getString(R.string.ctb_schedule_another_followup), getResources().getStringArray(R.array.yes_no_options), null, App.HORIZONTAL, App.VERTICAL, true, "FOLLOW UP VISIT", getResources().getStringArray(R.array.yes_no_list_concept));

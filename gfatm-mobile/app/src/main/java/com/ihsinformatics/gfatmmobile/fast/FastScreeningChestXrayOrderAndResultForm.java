...
public class FastScreeningChestXrayOrderAndResultForm extends AbstractFormActivity implements RadioGroup.OnCheckedChangeListener{
  ...
  //  LinearLayout linearLayout;
    ...
    public View onCreateView(LayoutInflater inflater,
        ...
        pageCount = 1;
        formName = Forms.FAST_SCREENING_CHEST_XRAY_ORDER_AND_RESULT_FORM;
        ...
        AsyncTask<String, String, String> submissionFormTask = new AsyncTask<String, String, String>() {
            ...
            protected String doInBackground(String... params) {
                ...
                if (App.get(formType).equals(getResources().getString(R.string.fast_order))) {
                    result = serverService.saveEncounterAndObservation(App.getProgram()+"-"+"Screening CXR Test Order", form, formDateCalendar, observations.toArray(new String[][]{}), true);
                    if (result.contains("SUCCESS"))
                        return "SUCCESS";
                } else if (App.get(formType).equals(getResources().getString(R.string.fast_result))) {
                    result = serverService.saveEncounterAndObservation(App.getProgram()+"-"+"Screening CXR Test Result", form, formDateCalendar, observations.toArray(new String[][]{}), false);
                    if (result.contains("SUCCESS"))
                        return "SUCCESS";
                }

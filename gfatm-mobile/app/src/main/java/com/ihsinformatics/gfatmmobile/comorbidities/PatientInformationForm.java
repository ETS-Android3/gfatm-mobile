...
public class PatientInformationForm extends AbstractFormActivity {
    ...
    TitledSpinner screeningFacilityLocationSpinner;
    ...
    public void initViews() {
        ...
        screeningFacilityLocationSpinner = new TitledSpinner(mainContent.getContext(), "", "Screening Facility Location: ", getResources().getStringArray(R.array.comorbidities_location), "Sehatmand Zindagi Center - Korangi", App.HORIZONTAL);
        ...
        viewGroups = new View[][]
                {{formDate, indexPatientId, scanQRCode, indexExternalPatientId, screeningFacilityLocationSpinner},
                        {firstName, lastName, husbandName, gender},

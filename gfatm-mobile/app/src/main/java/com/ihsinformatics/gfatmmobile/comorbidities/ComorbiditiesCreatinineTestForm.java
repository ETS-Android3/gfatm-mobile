...
public class ComorbiditiesCreatinineTestForm extends AbstractFormActivity implements RadioGroup.OnCheckedChangeListener {
    ...
    public View onCreateView(LayoutInflater inflater,
        ...
        pageCount = 1;
        formName = Forms.COMORBIDITIES_CREATININE_TEST_FORM;
    ...
    public void initViews() {
        ...
        //testId = new TitledEditText(context, null, getResources().getString(R.string.comorbidities_hhba1c_testid), "", "", 11, null, InputType.TYPE_CLASS_TEXT, App.HORIZONTAL, true);
        ...
        views = new View[]{formDate.getButton(), testId.getEditText(), formType.getRadioGroup(), creatinineFollowupMonth.getSpinner(), orderId.getEditText(), orderIds.getSpinner(),
        ...
        viewGroups = new View[][]
                {{formType, formDate, orderId, testOrderCreatinine, creatinineFollowupMonth, creatinineTestOrderDate,
                        testResultCreatinine, orderIds, testId, creatinineTestResultDate, creatinineResult, nextCreatinineTestDate}};
            ...
            if (formDateCalendar.after(App.getCalendar(date))) {
                ...
                if (formType.getRadioGroup().getSelectedValue().equalsIgnoreCase(getResources().getString(R.string.comorbidities_testorder_testresult_form_type_testresult))) {
                    ...
                    if (!App.get(orderIds).equals("")) {
                        String encounterDateTime = serverService.getEncounterDateTimeByObs(App.getPatientId(), App.getProgram() + "-" + "Creatinine Test Order", "ORDER ID", App.get(orderIds));
    ...
    public boolean validate() {
        ...
        if(orderIds.getVisibility()==View.VISIBLE && flag1){
            String[] resultTestIds = serverService.getAllObsValues(App.getPatientId(), App.getProgram() + "-" + "Creatinine Test Result", "ORDER ID");
        ...
        if(testId.getVisibility() == View.VISIBLE && flag1){
            String[] resultTestIds = serverService.getAllObsValues(App.getPatientId(), App.getProgram() + "-" + "Creatinine Test Result", "TEST ID");
            if(resultTestIds != null) {
                for (String id : resultTestIds) {
    ...
    public void resetViews() {
        ...
        String[] testIds = serverService.getAllObsValues(App.getPatientId(), App.getProgram() + "-" + "Creatinine Test Order", "ORDER ID");
        if(testIds != null) {

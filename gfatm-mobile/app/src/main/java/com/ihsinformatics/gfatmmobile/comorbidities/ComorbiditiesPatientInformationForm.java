...
public class ComorbiditiesPatientInformationForm extends AbstractFormActivity implements RadioGroup.OnCheckedChangeListener {
    ...
    public void initViews() {
        ...
        indexExternalPatientId = new TitledEditText(context, null, getResources().getString(R.string.pet_index_patient_external_id), "", "", 11, RegexUtil.EXTERNAL_ID_FILTER, InputType.TYPE_CLASS_TEXT, App.HORIZONTAL, true);
        ...
        city = new TitledSpinner(context, "", getResources().getString(R.string.comorbidities_patient_information_city), getResources().getStringArray(R.array.pet_empty_array), "", App.VERTICAL);
    ...
    public boolean validate() {
        ...
        if (otherNicOwner.getVisibility() == View.VISIBLE && App.get(otherNicOwner).isEmpty()) {
            gotoPage(1);
